...
The column 3 and 4 didn't work because character and factor could not be interpreted as numeric values here. Any words, like "hello" or "aaa" or "123", could be used in character vector and factor vector. Since the elements in these vectors were not always numbers, these two variable types did't have mean.
